...
export default function SearchBar({ visible, onClose, onLoadAll, tableRef }: SearchBarProps) {
  ...
  return (
    <div className="fixed top-20 right-8 z-[60] bg-surface-container-lowest rounded-2xl shadow-lg border border-outline-variant/20 p-3 flex items-center gap-2 animate-in slide-in-from-top">
