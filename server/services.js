...
// tarjeta terminación 1983 desde el 14-sep-2026; antes 9250) es un depósito a tarjeta: cuando la tarjeta llega a su límite de
...
// el sistema le manda la imagen al cliente (ver generateAndSendOxxoMpReference). Se apagó el 14-sep-2026
// con el cambio de cuenta y Chris la REACTIVÓ el 25-sep-2026 (kill-switch mpOxxoReferencesActive).
...
- Cuando pague con esa referencia, el sistema lo detecta automáticamente y se lo confirma; el cliente NO necesita mandar comprobante. Si aun así manda la foto del ticket de OXXO de esa referencia, dalo por válido si el monto coincide (esa referencia NO termina en 1983 ni en 9250: NO lo marques como sospechoso por eso) y responde ÚNICAMENTE con /comprobante si cubre el total.`;
...
Aquí "comprobante" es SOLO el de un pago o envío de dinero de una persona a un comercio (transferencia, SPEI, depósito, OXXO, pago con tarjeta). NO lo son, aunque digan "pago" o "método de pago": facturas o CFDI, recibos de impuestos (predial, tenencia), de servicios (luz, agua, teléfono, gas), estados de cuenta, identificaciones ni comprobantes de domicilio; los clientes a veces los mandan solo para dar su dirección. Con esos pon "esComprobante":false.`;
