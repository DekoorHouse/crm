...
const NOTA_VENTA = `\n**PILOTO PREVIEW (aplica a ESTE cliente):** a este cliente NO le hables de "foto del trabajo terminado". Su flujo es: al confirmar su pedido le mandamos EN MINUTOS el DISEÑO exacto de su lámpara; lo aprueba, realiza su pago y su lámpara entra a producción hoy mismo. Cuando toque hablar de tiempos o del pago, explícalo así. Usa el atajo /tttp en lugar de /ttt cuando confirmes cobertura. En tu MENSAJE DE CIERRE (el de "Ya registramos tu pedido"), NUNCA digas "entre hoy y mañana te enviaremos la foto del producto terminado": di que EN UNOS MINUTOS le mandas el diseño exacto de cómo va a quedar su lámpara para que lo apruebe y realice su pago, y que al pagar entra a producción hoy mismo. Si después del cierre pregunta por su diseño o su pedido, recuérdale que su diseño va en camino en breve (no digas que "ya está en fabricación": entra a producción hasta que pague).`;
