/**
 * Seed: crea la respuesta rápida "Datos DGO" que usa el botón
 * "Pedir Datos de Envío (DGO)" del CRM para mandar el enlace del formulario
 * de entrega local en Durango.
 *
 * Uso: node scripts/seed-quick-reply-dgo.js [--force]
 * Requiere: FIREBASE_SERVICE_ACCOUNT_JSON en .env (o serviceAccountKey.json en la raíz).
 *
 * Idempotente: si ya existe un atajo "Datos DGO" no lo duplica.
 *
 * El endpoint /api/repartos-dgo/pedir-datos/:contactId reemplaza ** por el
 * número de pedido e inyecta el pedido en la URL /dgo -> /dgo/DHxxxx.
 */
