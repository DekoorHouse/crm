...
- Spline cúbica interpolada: clic para cada punto, Enter/doble clic para terminar, Escape para cancelar y Retroceso para quitar el último punto. Máximo 500 puntos. Se guarda como puntos normalizados y se exporta como curvas Bézier SVG; permite mover, redimensionar y cambiar contorno. Doble clic en una spline edita sus nodos: arrastrarlos los mueve (con ajuste a otras figuras), Shift o un área seleccionan varios, las flechas los desplazan 1 mm (Shift: 10 mm), doble clic en la curva añade un nodo y doble clic en un nodo o Supr lo elimina (mínimo dos). Esc o clic en una zona vacía termina la edición. Aún no incluye cierre de curvas.
